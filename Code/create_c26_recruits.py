...
query = """ INSERT INTO recruit(first_name,surname,chat_name,github_name,id_number,personal_email_address,cohort_recruits)
VALUES
...
class Recruit(db.Model):
    ...
    rocketchat_name = db.Column(db.VARCHAR(50))
